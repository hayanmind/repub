# CLAUDE.md — RePub (ePub 3.0 인터랙티브 리마스터링 시스템)

> **서비스 출시명**: **RePub** — Re-imagined ePub. AI가 다시 짓는 전자책.
> 모든 외부 노출 자료(웹 대시보드, 카드뉴스, 영상, 발표자료, GitHub README 등)에서 서비스명을 일관되게 **RePub** 으로 표기한다. 과제명·보고서 제목·계약서 등 정부 사업 공식 문서에서는 사업계획서 표기("AI 기반 ePub 2.0 이하 전자책의 ePub 3.0 인터랙티브 리마스터링 기술 개발")를 그대로 사용한다.
...
- **최종평가**: 2026.5.6(수) 14:00~16:00, 진흥원 서울사무소 903호 — 발표 15분 + 시연 + Q&A 10분
- **최종보고서 제출**: 2026.4.29(수) sora@kpipa.or.kr
...
- 2026.4: 접근성 강화 + 베타 피드백 반영 + 공인성적서 / **외주 2건 정산·납품 완료** / **최종보고서·발표자료 작성 (4.26)**
- 2026.4.29: **최종보고서·발표자료·결과물 진흥원 제출** (sora@kpipa.or.kr)
- 2026.5.6: **최종평가 발표** (진흥원 서울사무소 903호, 15분 발표 + 시연 + Q&A 10분)
- 2026.5: 웹 인터페이스 베타 + 평가위원 피드백 반영 + FGI 진행
- 2026.6: GitHub 오픈소스 정식 공개 + 최종 실적보고서 (~6.30) + B2B 영업 가동
...
| 외주: 이비티솔루션 결과물 | ✅ 완료 (v3) | 결과보고서/납품서/검수조서 PDF + 양사 직인 + 김대훈 CTO 서명 + Python 분석 도구 epub_analyzer v1.0 |
| 외주: 플락 결과물 | ✅ 완료 | 결과보고서/납품서/검수조서 + 카드뉴스 20세트(159장) + 영상 4편 (RePub 브랜딩) |
| 최종평가 자료 (보고서·발표자료) | ✅ 작성 완료 (4.26) | `docs source 리포 / source/8. 최종평가/` — HWP 양식 본문 + 슬라이드 15장 |
